...
import OCRModal from '../../public/Register/modals/OCRModal';
import VerificationModal from '../../public/Register/modals/VerificationModal';
...
export default function StudentVehicles() {
  ...
  const handleVerificationConfirm = (verifiedData) => {
    setFormData(prev => ({
      ...prev,
      plateNumber: verifiedData.plateNumber || prev.plateNumber,
      make: verifiedData.make || prev.make,
      model: verifiedData.model || prev.model
    }));
    setShowVerificationModal(false);
    success("✓ Form auto-filled from your scan!");
  };
    ...
    <div className="premium-dashboard-container">
      ...
      <div className="premium-page-header">
        ...
        <div className="premium-header-meta">
          <div className="premium-id-badge">ID: <strong>{vehicles.length > 0 ? vehicles[0].plate_number : 'Register Now'}</strong></div>
      ...
      <div className="premium-info-panel">
        ...
        <div className="premium-info-list">
          <div className="premium-info-item">
            ...
            Students can register up to {maxVehicles} vehicles
          </div>
          <div className="premium-info-item">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="m5 12 5 5L20 7"/></svg>
            Vehicle registration is valid for one academic year
          </div>
          <div className="premium-info-item">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="m5 12 5 5L20 7"/></svg>
        ...
        <div className="modal-backdrop active" onClick={() => setShowModal(false)}>
          <div className="modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <div className="scan-id-action mb-6" style={{ background: 'var(--ac-d)', padding: '15px', borderRadius: '12px', border: '1px dashed var(--ac-b)', marginBottom: '20px' }}>
                <button type="button" className="premium-page-btn active" style={{ width: '100%', justifyContent: 'center' }} onClick={() => setShowOCRModal(true)}>
                  <span style={{ marginRight: '8px' }}>📷</span> Scan Vehicle Docs (Auto-Fill)
                </button>
                <p style={{ fontSize: '11px', color: 'var(--t-3)', textAlign: 'center', marginTop: '8px', marginContent: '0' }}>Scan your OR/CR or plate for instant data extraction</p>
              </div>
      ...
      {showOCRModal && (
        <OCRModal
          ...
          onManualInput={() => setShowOCRModal(false)}
